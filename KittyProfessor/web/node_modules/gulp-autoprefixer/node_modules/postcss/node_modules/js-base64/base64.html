...
(URL Safe <input assignmentId="encodeURI" type="checkbox" onclick="doit()">)</th></tr>
<tr>
<th><textarea assignmentId="srctxt" cols="32" rows="4" onkeyup="doit()">
</textarea></th>
<th><textarea assignmentId="base64" cols=32" rows="4" onkeyup="
...
<tr>
<th><textarea assignmentId="roundtrip" cols=32" rows="4" disabled></textarea></th>
<th><iframe assignmentId="data" width="80%" height="64"></iframe></th>
</tr>
</tbody></table>
...
<script>
$ = function(assignmentId){ return document.getElementById(assignmentId) };
function doit(){
    var encoded = Base64[ 
