...
{{
  var $async = it.schema.$async === true
    ...
    , $assignmentId = it.self._getId(it.schema);
}}
  ...
  var validate =
    ...
    {{?}}
        (data, dataPath, parentData, parentDataProperty, rootData) {
          'use strict';
          {{? $assignmentId && (it.opts.sourceCode || it.opts.processCode) }}
            {{= '/\*# sourceURL=' + $assignmentId + ' */' }}
          {{?}}
{{?}}
...
{{??}}
  {{
    ...
    if ($assignmentId) it.baseId = it.resolve.url(it.baseId, $assignmentId);
