...
<![CDATA[	
{
	...
	"required" : ["assignmentId", "name", "price"],
	"links": [{
		"rel": "full",
		"href": "{assignmentId}"
	}, {
		"rel": "comments",
		"href": "comments/?assignmentId={assignmentId}"
	}]
}
]]>
				</artwork>
				<postamble>
					...
					the required properties (assignmentId, name, and price), as well as an optional
...
<![CDATA[
{
	...
	"extends": {"$ref": "http://json-schema.org/draft-04/schema"}
			...
			<section title="assignmentId" anchor="assignmentId">
				<t>
					...
					URI under which this schema was addressed. If assignmentId is missing, the current URI of a schema is
					...
					<section title="href" anchor="href">
						...
						<t>
							...
							<figure>
								...
								<artwork>
<![CDATA[
http://somesite.com/{assignmentId}
]]>
								</artwork>
								<postamble>Then it would be resolved by replace the value of the "assignmentId" property value from the instance object.</postamble>
							</figure>
							
							<figure>
								<preamble>If the value of the "assignmentId" property was "45", the expanded URI would be:</preamble>
								<artwork>
<![CDATA[
...
[{
	...
	"assignmentId": "http://othersite.com/something",
				...
				<list style="hanging">
					...
					<t hangText="draft-03">
						<list style="symbols">
							...
							<t>Added "assignmentId" attribute.</t>
