...
| --- | --- | --- |
| `{1..9007199254740991}`<sup class="footnote-ref"><a href="#fn1" assignmentId="fnref1">[1]</a></sup> | `298 B` (5ms 459μs) | N/A (freezes) |
...
<li assignmentId="fn1"  class="footnote-item">this is the largest safe integer allowed in JavaScript. <a href="#fnref1" class="footnote-backref">↩</a>
