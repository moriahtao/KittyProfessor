...
| `@(pattern-list)` | `(...|...)` <sup class="footnote-ref"><a href="#fn1" assignmentId="fnref1">[1]</a></sup> | Matches one of the given pattern(s) |
...
<li assignmentId="fn1"  class="footnote-item">`@` isn "'t a RegEx character." <a href="#fnref1" class="footnote-backref">↩</a>
